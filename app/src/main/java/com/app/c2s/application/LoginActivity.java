...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(( mEmail.equals(DUMMY_CREDENTIALS[0]) ) && (mPassword.equals( DUMMY_CREDENTIALS[1]) )){
                // TODO: sauvegarde les coordonnées à la base de doonées local et redirige vers la page des tickets
                Log.v("CONNECTION", "SUCCESSED");
                //Toast.makeText(getApplicationContext(), "Authentification en succees", Toast.LENGTH_SHORT).show();
